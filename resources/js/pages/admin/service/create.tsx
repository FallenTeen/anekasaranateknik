...
export default function ServiceCreate({ kategori }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('admin.services.jasa.store'), {
            data: formData,
            forceFormData: true,
        });
    };
    ...
    const breadcrumbs = [
        ...
        { title: 'Tambahkan Jasa', href: route('admin.services.jasa.create') },
    ];

    return (
        <AppSidebarLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambahkan Jasa" />
            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Tambahkan Jasa Baru</h1>
                        <p className="text-gray-600">Lengkapi informasi jasa untuk menambahkan ke layanan</p>
                    </div>
                </div>
